      ...
      {products?.map((product) => (
        ...
        <div key={product.id}
          ...
          <ResponsiveImage
            ...
            alt={product.name}
          />
          <div className="mt-4 text-lg font-semibold leading-tight text-gray-900 hover:underline">
            {product.name}
          </div>
          <ul className="mt-2 flex items-center gap-4">
            ...
            <li>
              <CartCount sku={product.sku} checkoutData={checkoutData}/>
            </li>
          </ul>
          <p
            className="mt-4 text-2xl font-extrabold leading-tight text-gray-900">{formatCurrency(product.price * 100)}</p>
