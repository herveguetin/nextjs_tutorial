...
export default function Indicator({ checkoutData }: { checkoutData: CheckoutData }) {
  ...
  function toggleDrawer() {
    pubsub.emit()('minicart:drawer:toggle', { detail: true })
  }

  return (
    <div onClick={toggleDrawer} className="relative inline-flex items-center px-1 text-sm font-medium text-center cursor-pointer">
